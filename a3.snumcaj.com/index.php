...
<body>
  <div id="main-bg">
    <div id="navbar">
      ...
      <div id="nav-menu">
        <div id="nav-buttons">
          <a href="index.php"><button type="button" class="active">HOME</button></a>
    ...
    <div class="hero-container">
      <div class="hero-left">
        <video class="hero-main-logo" autoplay loop muted playsinline>
          <source src="Matrimaa-video.mp4" type="video/mp4" />
      ...
      <div class="hero-right">
        ...
        <img src="big-crown.png" class="hero-crown-img" alt="Matrimaa Crown" />
      </div>
    </div>
  </div>
  ...
  <div id="red-bg">
    ...
    <div class="model-wrapper">
      <img src="mother.png" class="model-img" alt="Mother" />
      <img src="small-crown.png" class="mother-crown" alt="Crown" />
    </div>
  </div>
  ...
  <div id="stats-section">
    ...
    <p class="stats-tagline">CELEBRATING WOMEN, CREATING IMPACT</p>
  </div>
    ...
    <div class="marquee-container">
      <div class="marquee-track">
        <div class="gallery-card">
          <img src="image-1.png" alt="Felicitation Ceremony" />
        </div>

        <div class="gallery-card">
          <img src="image-2.png" alt="Stage Honors" />
        </div>

        <div class="gallery-card">
          <img src="image-3.png" alt="Coronation Night" />
        </div>

        <div class="gallery-card">
          <img src="image-4.png" alt="Special Recognition" />
        </div>

        <div class="gallery-card">
          <img src="image-5.png" alt="Cherished Moments" />
        </div>

        <div class="gallery-card">
          <img src="image-6.png" alt="Grand Jury Panel" />
        </div>
  ...
  <script>
    ...
    // Crown Fade-in Observer
    const redBg = document.querySelector("#red-bg");
    const crown = document.querySelector(".mother-crown");
