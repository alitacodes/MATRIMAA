  ...
  <body>
    ...
    <div id="navbar">
      ...
      <div id="nav-buttons">
        ...
        <a href="media.html"><button type="button">GALLERY</button></a>
        ...
        <div class="carousel-wrapper">
          ...
          <div class="carousel-3d-viewport">
            <div class="carousel-3d-track" id="carouselTrack">
              <!-- SEASON 1 -->
              <div
                class="glass-card item-3d"
                data-index="0"
                data-category="season1"
              >
